...
void JoyStick_Init(void){
  //PB17 (HORI) <td>ADC1 channel 4 <td>J2.18 ***free***
//PB19 (VERT) ADC1 channel 6 <td>J3.23 MKII Accelerometer X
  // ADC_Init(ADC1,4,ADCVREF_VDDA); // x position joystick
  // ADC_Init(ADC1,6,ADCVREF_VDDA); // y position joystick
